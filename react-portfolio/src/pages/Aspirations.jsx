  ...
  return (
    <div>
      ...
      <div className='flex justify-center  text-white bg-gradient-to-r from-neutral to-secondary'>
        <div className='flex content-center text-5xl text-center font-thin p-14 mr-20 ml-20 rounded-3xl text-white bg-gradient-to-r from-neutral to-secondary bg-transparent shadow-2xl'>
